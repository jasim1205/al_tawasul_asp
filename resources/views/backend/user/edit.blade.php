                    ...
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="contact_en" class="form-control shadow-lg" value="{{ old('contact_en',$user->contact_en)}}" name="contact_en">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="contact_bn" class="form-control shadow-lg" value="{{ old('contact_bn',$user->contact_bn)}}" name="contactNumber_bn">
